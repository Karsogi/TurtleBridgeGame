...
public class Board extends AbstractTableModel implements GameEventListener {
    ...
    @Override public Object getValueAt(int r, int c) { return cells[r][c]; }

    private void put(int r, int c, int v) { cells[r][c] = v; fireTableCellUpdated(r, c); }

    public KeyAdapter createKeyListener() {
        return new KeyAdapter() {
            @Override public void keyPressed(KeyEvent e) {
                switch (e.getKeyCode()) {
                    case KeyEvent.VK_A: moveHero(-1); break;
                    case KeyEvent.VK_D: moveHero(1);  break;
                    case KeyEvent.VK_R: reset();      break;
                    case KeyEvent.VK_S: events.fire(new StartEvent(this)); break;
                    case KeyEvent.VK_P: events.fire(new PlusOneEvent(this)); break;
                }
            }
        }; }
    ...
    public void reset() {
        ...
        heroRow=0;heroCol=0;cells[0][0]=HERO;
    ...
    @Override public void handle(GameEvent e){ if(e instanceof TickEvent) stepTurtles(); }
